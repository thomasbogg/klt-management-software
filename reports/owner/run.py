...
def update_bookings_reports_workbooks(
    ...
    Args:
        ...
        reset: Whether to reset existing sheets for the date range instead of updating.
        allPrices: Whether to include all prices in the report.
    Returns:
    ...
    for property in properties:
        ...
        filename = f'{property.name}, Bookings Report'
        if allPrices:
            filename += ' (FULL)'
        filename += '.xlsx'
